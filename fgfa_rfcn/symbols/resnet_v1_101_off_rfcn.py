...
class resnet_v1_101_off_rfcn(Symbol):
    ...
    def get_feat_symbol(self, cfg):
        ...
        group = mx.sym.Group([conv_feat, im_info, data_cache, feat_cache]) #data_cache,
        self.sym = group
        return group
    ...
    def get_aggregation_symbol(self, cfg):
        ...
        # group output
        group = mx.sym.Group([data_cur, data_cache, rois, cls_prob, bbox_pred])
        self.sym = group
        return group
