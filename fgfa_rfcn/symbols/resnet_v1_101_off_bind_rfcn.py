...
class resnet_v1_101_off_bind_rfcn(Symbol):
    ...
    def get_off_resnet(self, data):
        ...
        #off_res_bn3 = mx.sym.BatchNorm(name='off_res_bn3', data=off_res_conv3, use_global_stats=self.use_global_stats, eps=self.eps, fix_gamma=False)
        off_res_add2 = mx.symbol.broadcast_add(name='off_res_add2', *[data, off_res_conv6])
        ...
        #off_res_bn3 = mx.sym.BatchNorm(name='off_res_bn3', data=off_res_conv3, use_global_stats=self.use_global_stats, eps=self.eps, fix_gamma=False)
        off_res_add3 = mx.symbol.broadcast_add(name='off_res_add3', *[data, off_res_conv9])
        return off_res_add3
