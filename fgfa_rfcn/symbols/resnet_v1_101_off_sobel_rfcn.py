...
class resnet_v1_101_off_sobel_rfcn(Symbol):
    ...
    def get_train_symbol(self, cfg):
        ...
        off_res_out1 = self.get_off_resnet(off_concat)
    ...
    def init_weight(self, cfg, arg_params, aux_params):
       ...
       # arg_params['em_conv1_bias'] = mx.nd.zeros(shape=self.arg_shape_dict['em_conv1_bias'])
        ...
        sobel_kernel = mx.ndarray.array([[0,1,0],[-1,0,1],[0,-1,0]]) 
        arg_params['sobel_conv2_weight'] = sobel_kernel.broadcast_to(self.arg_shape_dict['sobel_conv2_weight'])
        arg_params['sobel_conv2_bias'] = mx.nd.zeros(shape=self.arg_shape_dict['sobel_conv2_bias'])
