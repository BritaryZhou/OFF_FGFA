...
class resnet_v1_101_off6_concat_rfcn(Symbol):
    ...
    def get_off_resnet(self, data):
        off_res_relu1 = mx.symbol.Activation(name='off_res_relu1', data=data, act_type='relu')
        off_res_conv1 = mx.sym.Convolution(name='off_res_conv1', data=off_res_relu1, kernel=(1, 1), pad=(0, 0), stride=(1,1), num_filter=256)
        #off_res_bn1 = mx.sym.BatchNorm(name='off_res_bn1', data=off_res_conv1, use_global_stats=self.use_global_stats, eps=self.eps, fix_gamma=False)
        off_res_relu2 = mx.symbol.Activation(name='off_res_relu2', data=off_res_conv1, act_type='relu')
        off_res_conv2 = mx.sym.Convolution(name='off_res_conv2', data=off_res_relu2, kernel=(3, 3), pad=(1, 1), stride=(1,1), num_filter=256)
        #off_res_bn2 = mx.sym.BatchNorm(name='off_res_bn2', data=off_res_conv2, use_global_stats=self.use_global_stats, eps=self.eps, fix_gamma=False)
        off_res_relu3 = mx.symbol.Activation(name='off_res_relu3', data=off_res_conv2, act_type='relu')
        off_res_conv3 = mx.sym.Convolution(name='off_res_conv3', data=off_res_relu3, kernel=(1, 1), pad=(0, 0), stride=(1,1), num_filter=1024)
        #off_res_bn3 = mx.sym.BatchNorm(name='off_res_bn3', data=off_res_conv3, use_global_stats=self.use_global_stats, eps=self.eps, fix_gamma=False)
        off_res_add1 = mx.symbol.broadcast_add(name='off_res_add1', *[data, off_res_conv3])
        off_res_relu4 = mx.symbol.Activation(name='off_res_relu4', data=off_res_add1, act_type='relu')
        off_res_conv4 = mx.sym.Convolution(name='off_res_conv4', data=off_res_relu4, kernel=(1, 1), pad=(0, 0), stride=(1,1), num_filter=256)
        #off_res_bn1 = mx.sym.BatchNorm(name='off_res_bn1', data=off_res_conv1, use_global_stats=self.use_global_stats, eps=self.eps, fix_gamma=False)
        off_res_relu5 = mx.symbol.Activation(name='off_res_relu5', data=off_res_conv4, act_type='relu')
        off_res_conv5 = mx.sym.Convolution(name='off_res_conv5', data=off_res_relu5, kernel=(3, 3), pad=(1, 1), stride=(1,1), num_filter=256)
        #off_res_bn2 = mx.sym.BatchNorm(name='off_res_bn2', data=off_res_conv2, use_global_stats=self.use_global_stats, eps=self.eps, fix_gamma=False)
        off_res_relu6 = mx.symbol.Activation(name='off_res_relu6', data=off_res_conv5, act_type='relu')
        off_res_conv6 = mx.sym.Convolution(name='off_res_conv6', data=off_res_relu6, kernel=(1, 1), pad=(0, 0), stride=(1,1), num_filter=1024)
        #off_res_bn3 = mx.sym.BatchNorm(name='off_res_bn3', data=off_res_conv3, use_global_stats=self.use_global_stats, eps=self.eps, fix_gamma=False)
        off_res_add2 = mx.symbol.broadcast_add(name='off_res_add2', *[off_res_add1, off_res_conv6])
        off_res_relu7 = mx.symbol.Activation(name='off_res_relu7', data=off_res_add2, act_type='relu')
        off_res_conv7 = mx.sym.Convolution(name='off_res_conv7', data=off_res_relu7, kernel=(1, 1), pad=(0, 0), stride=(1,1), num_filter=256)
        #off_res_bn1 = mx.sym.BatchNorm(name='off_res_bn1', data=off_res_conv1, use_global_stats=self.use_global_stats, eps=self.eps, fix_gamma=False)
        off_res_relu8 = mx.symbol.Activation(name='off_res_relu8', data=off_res_conv7, act_type='relu')
        off_res_conv8 = mx.sym.Convolution(name='off_res_conv8', data=off_res_relu8, kernel=(3, 3), pad=(1, 1), stride=(1,1), num_filter=256)
        #off_res_bn2 = mx.sym.BatchNorm(name='off_res_bn2', data=off_res_conv2, use_global_stats=self.use_global_stats, eps=self.eps, fix_gamma=False)
        off_res_relu9 = mx.symbol.Activation(name='off_res_relu9', data=off_res_conv8, act_type='relu')
        off_res_conv9 = mx.sym.Convolution(name='off_res_conv9', data=off_res_relu9, kernel=(1, 1), pad=(0, 0), stride=(1,1), num_filter=1024)
        #off_res_bn3 = mx.sym.BatchNorm(name='off_res_bn3', data=off_res_conv3, use_global_stats=self.use_global_stats, eps=self.eps, fix_gamma=False)
        off_res_add3 = mx.symbol.broadcast_add(name='off_res_add3', *[off_res_add2, off_res_conv9])
        off_res_relu10 = mx.symbol.Activation(name='off_res_relu10', data=off_res_add3, act_type='relu')
        off_res_conv10 = mx.sym.Convolution(name='off_res_conv10', data=off_res_relu10, kernel=(1, 1), pad=(0, 0), stride=(1,1), num_filter=256)
        #off_res_bn1 = mx.sym.BatchNorm(name='off_res_bn1', data=off_res_conv1, use_global_stats=self.use_global_stats, eps=self.eps, fix_gamma=False)
        off_res_relu11 = mx.symbol.Activation(name='off_res_relu11', data=off_res_conv10, act_type='relu')
        off_res_conv11 = mx.sym.Convolution(name='off_res_conv11', data=off_res_relu11, kernel=(3, 3), pad=(1, 1), stride=(1,1), num_filter=256)
        #off_res_bn2 = mx.sym.BatchNorm(name='off_res_bn2', data=off_res_conv2, use_global_stats=self.use_global_stats, eps=self.eps, fix_gamma=False)
        off_res_relu12 = mx.symbol.Activation(name='off_res_relu12', data=off_res_conv11, act_type='relu')
        off_res_conv12 = mx.sym.Convolution(name='off_res_conv12', data=off_res_relu12, kernel=(1, 1), pad=(0, 0), stride=(1,1), num_filter=1024)
        #off_res_bn3 = mx.sym.BatchNorm(name='off_res_bn3', data=off_res_conv3, use_global_stats=self.use_global_stats, eps=self.eps, fix_gamma=False)
        off_res_add4 = mx.symbol.broadcast_add(name='off_res_add4', *[off_res_add3, off_res_conv12])
        off_res_relu13 = mx.symbol.Activation(name='off_res_relu13', data=off_res_add4, act_type='relu')
        off_res_conv13 = mx.sym.Convolution(name='off_res_conv13', data=off_res_relu13, kernel=(1, 1), pad=(0, 0), stride=(1,1), num_filter=256)
        #off_res_bn1 = mx.sym.BatchNorm(name='off_res_bn1', data=off_res_conv1, use_global_stats=self.use_global_stats, eps=self.eps, fix_gamma=False)
        off_res_relu14 = mx.symbol.Activation(name='off_res_relu14', data=off_res_conv13, act_type='relu')
        off_res_conv14 = mx.sym.Convolution(name='off_res_conv14', data=off_res_relu14, kernel=(3, 3), pad=(1, 1), stride=(1,1), num_filter=256)
        #off_res_bn2 = mx.sym.BatchNorm(name='off_res_bn2', data=off_res_conv2, use_global_stats=self.use_global_stats, eps=self.eps, fix_gamma=False)
        off_res_relu15 = mx.symbol.Activation(name='off_res_relu15', data=off_res_conv14, act_type='relu')
        off_res_conv15 = mx.sym.Convolution(name='off_res_conv15', data=off_res_relu15, kernel=(1, 1), pad=(0, 0), stride=(1,1), num_filter=1024)
        #off_res_bn3 = mx.sym.BatchNorm(name='off_res_bn3', data=off_res_conv3, use_global_stats=self.use_global_stats, eps=self.eps, fix_gamma=False)
        off_res_add5 = mx.symbol.broadcast_add(name='off_res_add5', *[off_res_add4, off_res_conv15])
        off_res_relu16 = mx.symbol.Activation(name='off_res_relu16', data=off_res_add5, act_type='relu')
        off_res_conv16 = mx.sym.Convolution(name='off_res_conv16', data=off_res_relu16, kernel=(1, 1), pad=(0, 0), stride=(1,1), num_filter=256)
        #off_res_bn1 = mx.sym.BatchNorm(name='off_res_bn1', data=off_res_conv1, use_global_stats=self.use_global_stats, eps=self.eps, fix_gamma=False)
        off_res_relu17 = mx.symbol.Activation(name='off_res_relu17', data=off_res_conv16, act_type='relu')
        off_res_conv17 = mx.sym.Convolution(name='off_res_conv17', data=off_res_relu17, kernel=(3, 3), pad=(1, 1), stride=(1,1), num_filter=256)
        #off_res_bn2 = mx.sym.BatchNorm(name='off_res_bn2', data=off_res_conv2, use_global_stats=self.use_global_stats, eps=self.eps, fix_gamma=False)
        off_res_relu18 = mx.symbol.Activation(name='off_res_relu18', data=off_res_conv17, act_type='relu')
        off_res_conv18 = mx.sym.Convolution(name='off_res_conv18', data=off_res_relu18, kernel=(1, 1), pad=(0, 0), stride=(1,1), num_filter=1024)
        #off_res_bn3 = mx.sym.BatchNorm(name='off_res_bn3', data=off_res_conv3, use_global_stats=self.use_global_stats, eps=self.eps, fix_gamma=False)
        off_res_add6 = mx.symbol.broadcast_add(name='off_res_add6', *[off_res_add5, off_res_conv18])
        return off_res_add6
    ...
    def get_train_symbol(self, cfg):
        ...
        #conv_feat_ori_512 = mx.sym.SliceChannel(conv_feat_ori[0], axis=1, num_outputs=2)
        ...
        # select_conv_feat_slice_first = mx.symbol.slice_axis(off_pre_relu, axis=1, begin=0, end=255)
        #slice_diff = select_conv_feat_slice_last - select_conv_feat_slice_first

        #slice_diff_reshape = mx.symbol.reshape(slice_diff, shape=(1, 256, 0, 0))
        #sobel_input = feat
        #sobel_input = mx.symbol.reshape(feat, shape=(3, -1, 0, 0))  # frame_size*batch_size
        # slice_first_reshape = mx.symbol.reshape(slice_diff_reshape, shape=(96, -1, 28, 28))
        ...
        #off_concat_reshape = mx.symbol.reshape(off_concat, shape=(-1, 1024, 0, 0))

        off_res_out1 = self.get_off_resnet(slice_diff)
        concat_feat_off = mx.symbol.Concat(conv_feat_ori[0], off_res_out1, dim=1)

        #conv_feats = mx.sym.SliceChannel(off_res_out1, axis=1, num_outputs=2)

        # RPN layers
        rpn_feat = concat_feat_off
    ...
    def get_aggregation_symbol(self, cfg):
        ...
        #    aggregated_conv_feat = aggregation_conv_feat + tiled_weight * warp_list[i]
        ...
        off_pre_conv1 = mx.symbol.Convolution(name='off_pre_conv1', data=feat_cache, num_filter=1024, pad=(0, 0), kernel=(1, 1), stride=(1, 1))
        off_pre_relu1 = mx.symbol.Activation(name='off_pre_relu1', data=off_pre_conv1, act_type='relu')
        feat_cache_slice = mx.sym.SliceChannel(off_pre_relu1, axis=0, num_outputs=2) #  data, data_ref
        ...
        concat_feat_off = mx.symbol.Concat(conv_feat_ori[0], off_res_out11, dim=1)
        ...
        # group output
        group = mx.sym.Group([data_cur, data_ref, off_res_out11, data_cache, feat_cache, rois, cls_prob, bbox_pred])
        self.sym = group
        return group
    ...
    def init_weight(self, cfg, arg_params, aux_params):
        ...
        #arg_params['em_conv1_weight'] = mx.random.normal(0, self.get_msra_std(self.arg_shape_dict['em_conv1_weight']), shape=self.arg_shape_dict['em_conv1_weight'])
       # arg_params['em_conv1_bias'] = mx.nd.zeros(shape=self.arg_shape_dict['em_conv1_bias'])
        #arg_params['em_conv2_weight'] = mx.random.normal(0, self.get_msra_std(self.arg_shape_dict['em_conv2_weight']), shape=self.arg_shape_dict['em_conv2_weight'])
        #arg_params['em_conv2_bias'] = mx.nd.zeros(shape=self.arg_shape_dict['em_conv2_bias'])
        #arg_params['em_conv3_weight'] = mx.random.normal(0, self.get_msra_std(self.arg_shape_dict['em_conv3_weight']),shape=self.arg_shape_dict['em_conv3_weight'])
        ...
        arg_params['rfcn_bbox_bias'] = mx.nd.zeros(shape=self.arg_shape_dict['rfcn_bbox_bias'])
         ################################## off_res_init
        arg_params['off_pre_conv1_weight'] = mx.random.normal(0, self.get_msra_std(self.arg_shape_dict['off_pre_conv1_weight']), shape=self.arg_shape_dict['off_pre_conv1_weight'])
        arg_params['off_pre_conv1_bias'] = mx.nd.ones(shape=self.arg_shape_dict['off_pre_conv1_bias'])*0.2
        #arg_params['sobel_conv1_weight'] = mx.random.normal(0, self.get_msra_std(self.arg_shape_dict['sobel_conv1_weight']), shape=self.arg_shape_dict['sobel_conv1_weight'])
        #arg_params['sobel_conv1_bias'] = mx.nd.ones(shape=self.arg_shape_dict['sobel_conv1_bias'])*0.2
        #sobel
        #kx = mx.ndarray.array([[1, 2, 1]]).T * mx.ndarray.array([[-1, 0, 1]])
        #ky = kx.T
        for index in range(1,19):
            off_res_string_weight = 'off_res_conv' + str(index) + '_weight'
            off_res_string_bias = 'off_res_conv' + str(index) + '_bias'
            self.logger.info("init_weight:\n "+off_res_string_weight+off_res_string_bias)
            arg_params[off_res_string_weight] = mx.random.normal(0, self.get_msra_std(self.arg_shape_dict[off_res_string_weight]), shape=self.arg_shape_dict[off_res_string_weight])
            arg_params[off_res_string_bias] = mx.nd.ones(shape=self.arg_shape_dict[off_res_string_bias]) * 0.2
